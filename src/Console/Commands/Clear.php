...
class Clear extends Command
{
    ...
    protected $description = 'Clears cache and wipes all derivative image created by Imagery for Laravel. They will be recreated upon the next request, if the originals are still available.';
